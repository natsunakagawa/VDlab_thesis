...
\begin{figure}[htp]
  \begin{center}
    \includegraphics[height=60mm]{figure/block_diagram.eps}
    \vspace*{3mm}
...
\begin{figure}[htp]
  \begin{center}
    \includegraphics[height=60mm]{figure/relative_diagram.eps}
    \vspace*{3mm}
...
\begin{figure}[htp]
  \begin{center}
    \includegraphics[height=60mm]{figure/bode_inverse.eps}
